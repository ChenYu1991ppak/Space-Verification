...
# Output
parser.add_argument('--output_questions_dir',
    default='../output/questions_en',
...
def main(args):
  ...
  if not os.path.exists(args.output_questions_dir):
      os.mkdir(args.output_questions_dir)
  ...
  for fn in os.listdir(args.template_dir):
    ...
    with open(os.path.join(args.template_dir, fn), 'r', encoding='utf-8') as f:
  ...
  for i, scene in enumerate(all_scenes):
    ...
    for (fn, idx), template in templates_items:
      ...
      file_name = os.path.splitext(scene_fn)[0] + '_question.json'
      with open(os.path.join(args.output_questions_dir, file_name), 'w', encoding='utf-8') as f:
          print('Writing output to %s' % args.output_questions_dir)
          json.dump({
              'info': scene_info,
              'questions': questions,
